...
echo 'var SRV_ADDRESS 10.1.5.2' > /home/cctf/snort/snort.conf
echo '#drop tcp any any -> \$SRV_ADDRESS 80 (msg:"Flooder SYN detected and blocked" sid:1000001; flags: S; fragbits: !D;)' >> /home/cctf/snort/snort.conf
echo '#event_filter gen_id 1, sig_id 1000001, track by_src, count 1, seconds 10, type limit' >> /home/cctf/snort/snort.conf
echo '#alert tcp any any -> \$SRV_ADDRESS 80 (msg: "TPC SYN detected"; sid: 1000003; rev: 1; flags:S;)' >> /home/cctf/snort/snort.conf
...
echo 'drop tcp any any -> \$SRV_ADDRESS 80 (msg: "Detected junk traffic"; sid: 1000005;  pcre:"/.-. /";)' >> /home/cctf/snort/snort.conf
echo 'event_filter gen_id 1, sig_id 1000005, track by_src, count 5, seconds 10, type limit' >> /home/cctf/snort/snort.conf
echo 'alert tcp any any -> \$SRV_ADDRESS 80 (msg: "TCP SYN flood attack detected"; sid: 1000004; rev: 1; flags:S; detection_filter: track by_src, count 100, seconds 1;)' >> /home/cctf/snort/snort.conf
