...
use ctf2;UPDATE users SET pass = "$2y$10$hjH9n9FD8RtYhH7bNyDRw.tzrJmGR1yXUPWfevaeuZFwd6thfPEw." WHERE user = "jelena" and pass = "abcdef"; -- 2#Fj5DQAeabApy9Z (randomly generated with LastPass)
use ctf2;UPDATE users SET pass = "$2y$10$WYWRzt9h3LwJKribmS3uZ.qSOEOiOYfYxVFBg5rBtkWoyxlhJgDnW" WHERE user = "john" and pass = "abcdef"; -- vD85@&3Fj*VbKyu%
use ctf2;UPDATE users SET pass = "$2y$10$0jfgFbjr1m2Kf5B2HMGkB.IlR5q3TDODv4JrcMyhBlaAuF1w7TJrK" WHERE user = "kate" and pass = "abcdef"; -- U5j^^dt6G@4QeZhE